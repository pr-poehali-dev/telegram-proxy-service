...
export const translations = {
  ru: {
    ...
    portfolio: {
      ...
      titleHi: "показываем",
      subtitle:
        "150+ сайтов и проектов продвижения для бизнеса по всей России. Каждый — с реальным результатом и довольным клиентом.",
      filters: {
        all: "Все",
        landing: "Лендинги",
        shop: "Магазины",
      ...
      stats: {
        projects: "Проектов",
        clients: "Клиентов остаются",
        avgTime: "Средний срок",
        years: "На рынке",
      },
